  ...
  Ship.prototype.setInvulnerable = function(){
    ...
    Ship.prototype.move = function(ctx){
      ...
      if ( this.thrust ) {
        ...
        this.friction = 1;
        vel = Asteroids.Util.calcVec(1.6, this.angle);
    ...
    Ship.prototype.draw = function(ctx){
      ...
      Ship.sprite.src = './assets/falcon-merge.png';
      if (this.thrust) {
        ctx.drawImage(Ship.sprite, -40, -40, 80, 80);
      } else {
        ctx.drawImage(Ship.sprite, 0, 0, 180, 185, -40, -40, 70, 70);
      }
